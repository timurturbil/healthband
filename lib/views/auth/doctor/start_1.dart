...
class DoctorStart1View extends StatefulWidget {
  const DoctorStart1View({super.key});

  @override
  State<DoctorStart1View> createState() => _DoctorStart1ViewState();
}

class _DoctorStart1ViewState extends State<DoctorStart1View> {
