...
class ClosedListView extends StatefulWidget {
  const ClosedListView({super.key});

  @override
  State<ClosedListView> createState() => _ClosedListViewState();
}

class _ClosedListViewState extends State<ClosedListView> {
